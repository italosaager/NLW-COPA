  ...
  return (
    <div className="max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-28 items-center">
      ...
      <main>
        ...
        <form onSubmit={createPool} className="mt-10 flex grap-2 ">
          <input 
          className="flex-1 px-6 py-4 rounded bg-gray-800 border border-gray-600 text-sm text-gray-100" 
          type="text" required placeholder="Qual nome do seu bolão?" onChange={event => setPoolTitle(event.target.value)} value={poolTitle} />
      ...
      <Image src={appPreviewImg} alt="Previa" quality={100} />
    </div>
  );
}
